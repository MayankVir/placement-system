...
<html lang="en">
  <head>
    ...
    <title>Placement- Manage Students</title>
...
echo "<br><h3>Students Scored Above '$C12th' in 12thloma&nbsp:&nbsp";
echo $data['count(*)'];
echo "</h3>";
$sql = mysql_query("SELECT * FROM basicdetails WHERE `Approve`='1' AND `12th`>='$Cpu'");
