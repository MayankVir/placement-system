...
<html lang="en">
  <head>
    ...
    <title>Placement- CL Students</title>
 ...
 <center><h2>Approved Students List of CL</h2></center>
...
$sql = "SELECT * FROM basicdetails where Approve='1' and Branch='CL' LIMIT $start_from, $num_rec_per_page"; 
...
mysql_connect('localhost','root','');
mysql_select_db('details');
$sql = "SELECT * FROM basicdetails where Approve='1' and Branch='CL'"; 
$rs_result = mysql_query($sql); //run the query
		...
		if( $currentpage > 1 && $currentpage <= $totalpage)
			{
				...
				$prev = $currentpage-1;
				echo "<li><a  href='CL.php?page=".$prev."'><</a></li>";
...
$prev = $currentpage-1;
	for ($i=$prev+1; $i<=$currentpage+2; $i++){
		echo "<li><a href='CL.php?page=".$i."'>".$i."</a></li>";
  }
  }
	...
	{
		$nxt = $currentpage+1;
		echo "<li><a  href='CL.php?page=".$nxt."' >></a></li>";
	}
